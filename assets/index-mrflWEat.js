(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function e(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=e(s);fetch(s.href,o)}})();const f=Object.freeze({contentUrl:"/data/site-content.json",inquiryEmail:"admin@neocode.co.kr",revealDelayStep:.06}),m=Object.freeze({windows:{label:"Windows",icon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M3 5.4 10.4 4.4v7.1H3V5.4Zm8.6-1.2L21 3v8.5h-9.4V4.2ZM3 12.7h7.4v6.9L3 18.6v-5.9Zm8.6 0H21V21l-9.4-1.2v-7.1Z"/></svg>'},android:{label:"Android",icon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M7.7 7.4 6.2 4.8a.7.7 0 0 1 1.2-.7l1.5 2.6A8.4 8.4 0 0 1 12 6.1c1.1 0 2.1.2 3.1.6l1.5-2.6a.7.7 0 1 1 1.2.7l-1.5 2.6A6.6 6.6 0 0 1 19 12v.5H5V12c0-1.8 1-3.5 2.7-4.6ZM8.7 10.2a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm6.6 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM5 13.8h14v5.1c0 .9-.7 1.6-1.6 1.6H6.6c-.9 0-1.6-.7-1.6-1.6v-5.1Zm-2.2.2c0-.6.5-1.1 1.1-1.1S5 13.4 5 14v4.1a1.1 1.1 0 1 1-2.2 0V14Zm16.2 0a1.1 1.1 0 1 1 2.2 0v4.1a1.1 1.1 0 1 1-2.2 0V14Z"/></svg>',storeIcon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="#34a853" d="M4.4 2.7c-.3.3-.5.8-.5 1.4v15.8c0 .6.2 1.1.5 1.4l8.6-9.3-8.6-9.3Z"/><path fill="#4285f4" d="m13 12 2.9-3.1L5.2 2.8c-.3-.2-.6-.2-.8-.1L13 12Z"/><path fill="#fbbc04" d="m13 12-8.6 9.3c.2.1.5.1.8-.1l10.7-6.1L13 12Z"/><path fill="#ea4335" d="m15.9 8.9-2.9 3.1 2.9 3.1 3.7-2.1c1-.6 1-1.4 0-2l-3.7-2.1Z"/></svg>'},ios:{label:"iOS",icon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M16.8 2.2c.1 1-.3 2-1 2.8-.8.9-1.8 1.4-2.8 1.3-.1-1 .3-2 1-2.7.8-.9 1.8-1.4 2.8-1.4Zm2.9 15.4c-.5 1.1-.8 1.6-1.5 2.6-1 1.4-2.3 3-4 3-1.5 0-1.9-1-3.9-1s-2.5 1-3.9 1c-1.7 0-3-1.5-4-2.9-2.8-4-3.1-8.7-1.4-11.2 1.2-1.8 3.1-2.8 4.9-2.8 1.8 0 2.9 1 4.4 1 1.4 0 2.3-1 4.4-1 1.6 0 3.3.9 4.5 2.4-4 2.2-3.3 7.9.5 8.9Z"/></svg>',storeIcon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><rect width="20" height="20" x="2" y="2" fill="#0a84ff" rx="5"/><path fill="#fff" d="M8.1 17.8c-.5.8-1.5.2-1.1-.6l.9-1.6H5.6c-.8 0-.8-1.2 0-1.2h3l2.7-4.7-.9-1.6c-.4-.8.6-1.4 1.1-.6l.5.9.5-.9c.5-.8 1.5-.2 1.1.6l-4.7 8.1h2.5l.7 1.2H8.3l-.2.4Zm8.3-3.4h2c.8 0 .8 1.2 0 1.2h-1.3l.9 1.6c.4.8-.6 1.4-1.1.6l-3.1-5.4.7-1.2 1.9 3.2Z"/></svg>'},web:{label:"Web",icon:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="none" stroke="currentColor" stroke-width="1.8" d="M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0Zm2.2-3h13.6M5.2 15h13.6M12 3c2.2 2.4 3.3 5.4 3.3 9S14.2 18.6 12 21c-2.2-2.4-3.3-5.4-3.3-9S9.8 5.4 12 3Z"/></svg>'}}),n=(a,t=document)=>t.querySelector(a),h=(a,t=document)=>Array.from(t.querySelectorAll(a)),r=a=>String(a??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),c=a=>{const t=String(a||"#").trim(),e=["mailto:","tel:","tg:","kakaotalk:","discord:"];return t.startsWith("#")||t.startsWith("/")||t.startsWith("https://")||e.some(i=>t.startsWith(i))||t.startsWith("http://")||!/^[a-zA-Z][a-zA-Z\d+.-]*:/.test(t)?t:"#"},b=a=>!!String(a||"").trim(),$=(a,t)=>{const e=m[a];return e?b(t)&&e.storeIcon?e.storeIcon:e.icon:""},y=Object.freeze({telegram:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M21.7 4.2 18.6 20c-.2 1-1 1.3-1.8.8l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.4-5.1 9.3-8.4c.4-.4-.1-.6-.6-.3L6 13.3 1 11.7c-1-.3-1-1 0-1.4L20.2 3c.9-.3 1.7.2 1.5 1.2Z"/></svg>',discord:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M19.4 5.3A16 16 0 0 0 15.5 4l-.5 1a14.5 14.5 0 0 0-6 0l-.5-1a16 16 0 0 0-3.9 1.3C2.1 9.1 1.4 12.8 1.7 16.5A16 16 0 0 0 6.5 19l1-1.6c-.6-.2-1.1-.5-1.6-.8l.4-.3c3.1 1.4 8.2 1.4 11.3 0l.4.3c-.5.3-1 .6-1.6.8l1 1.6a16 16 0 0 0 4.8-2.5c.5-4.3-.7-7.9-2.8-11.2ZM8.3 14.2c-.9 0-1.6-.8-1.6-1.8s.7-1.8 1.6-1.8 1.7.8 1.6 1.8c0 1-.7 1.8-1.6 1.8Zm7.4 0c-.9 0-1.6-.8-1.6-1.8s.7-1.8 1.6-1.8 1.7.8 1.6 1.8c0 1-.7 1.8-1.6 1.8Z"/></svg>',kakao:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 4C6.7 4 2.4 7.3 2.4 11.4c0 2.6 1.8 4.9 4.5 6.2l-.8 2.9c-.1.4.3.7.6.5l3.6-2.4c.5.1 1.1.1 1.7.1 5.3 0 9.6-3.3 9.6-7.4S17.3 4 12 4Z"/></svg>',kakaotalk:'<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 4C6.7 4 2.4 7.3 2.4 11.4c0 2.6 1.8 4.9 4.5 6.2l-.8 2.9c-.1.4.3.7.6.5l3.6-2.4c.5.1 1.1.1 1.7.1 5.3 0 9.6-3.3 9.6-7.4S17.3 4 12 4Z"/></svg>'}),L=a=>{const t=String(a.icon||a.label||a.text||"").toLowerCase().replace(/[^a-z]/g,"");return y[t]||r(a.text||a.label||"")},g=(a,t="ic")=>{const e=String(a.iconUrl||"").trim();return e?`
      <div class="${t} app-icon-wrap">
        <img src="${r(c(e))}" alt="${r(`${a.title||"앱"} 아이콘`)}" loading="lazy" referrerpolicy="no-referrer" />
      </div>
    `:`<div class="${t}">${r(a.icon||"")}</div>`},w=`
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path d="M5 12h14M13 6l6 6-6 6"/>
  </svg>
`;class C{constructor(t){this.url=t}async load(){try{const t=await fetch(`${this.url}?t=${Date.now()}`,{cache:"no-store"});if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()}catch(t){return console.warn("site content load failed",t),null}}}class S{constructor(t){this.content=t}render(){this.content&&(this.renderMeta(),this.renderNavigation(),this.renderHero(),this.renderServiceSection("apps","#services","svc"),this.renderServiceSection("process","#process","process"),this.renderServiceSection("games","#games","game"),this.renderAbout(),this.renderContact(),this.renderFooter())}renderMeta(){const{site:t}=this.content;t!=null&&t.title&&(document.title=t.title);const e=n('meta[name="description"]');e&&(t!=null&&t.description)&&e.setAttribute("content",t.description)}renderNavigation(){var u;const t=n("#navLinks"),e=n(".nav-cta"),{nav:i}=this.content;if(!t||!i)return;const s=(u=i.items)==null?void 0:u[0],o=(i.items||[]).slice(1);if(t.innerHTML=`
    ...
    `}renderChips(t=[]){return t.length?`<div class="chips">${t.map(e=>`<span>${r(e)}</span>`).join("")}</div>`:""}renderPlatforms(t){const e=(t.platforms||[]).filter(i=>m[i.type]);return e.length?`
      <div class="platform-links" aria-label="${r(t.title)} 지원 플랫폼">
        <span class="platform-caption">지원 플랫폼</span>
        <div class="platform-icons">
          ${e.map(i=>{const s=m[i.type],o=i.label||s.label;return`
              <a
              ...
              >
                <span class="platform-symbol">${$(i.type,i.url)}</span>
                <span>${r(o)}</span>
              </a>
            `}).join("")}
        </div>
